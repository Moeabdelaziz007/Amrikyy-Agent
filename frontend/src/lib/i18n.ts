  ...
  agents: {
    ...
    marketing: {
      en: {
        ...
        mockResults: {
          marketResearch: "Market research complete: Identified key demographics and competitive landscape.",
          seoSpecialist: "SEO strategy optimized: Recommended keywords and content improvements for ranking.",
          contentStrategist: "Content strategy developed: Proposed blog posts, videos, and social media themes.",
          socialMediaManager: "Social media plan drafted: Scheduled posts and engagement tactics for Instagram.",
          campaignManager: "Marketing campaign launched: Initial results show strong engagement.",
          analyticsExpert: "Marketing data analyzed: Identified high-performing channels and areas for improvement.",
        },
      },
      ar: {
        name: "عميل التسويق",
        ...
        mockResults: {
          marketResearch: "اكتمل بحث السوق: تم تحديد التركيبة السكانية الرئيسية والمشهد التنافسي.",
          seoSpecialist: "تم تحسين استراتيجية تحسين محركات البحث: تم التوصية بالكلمات المفتاحية وتحسينات المحتوى للترتيب.",
          contentStrategist: "تم تطوير استراتيجية المحتوى: تم اقتراح منشورات المدونة والفيديوهات وموضوعات وسائل التواصل الاجتماعي.",
          socialMediaManager: "تم صياغة خطة وسائل التواصل الاجتماعي: تم جدولة المنشورات وتكتيكات التفاعل لإنستغرام.",
          campaignManager: "تم إطلاق الحملة التسويقية: تظهر النتائج الأولية تفاعلاً قوياً.",
          analyticsExpert: "تم تحليل بيانات التسويق: تم تحديد القنوات عالية الأداء ومجالات التحسين.",
        },
      },
    },
  },
