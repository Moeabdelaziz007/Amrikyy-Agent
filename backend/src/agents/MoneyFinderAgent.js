...
if (require.main === module) {
  ...
  (async () => {
    ...
    report.forecast.forEach((f) => {
      console.log(
        `  ${f.month}   | $${f.monthlyRevenue.toString().padStart(6)} ` +
          `      | $${f.cumulativeRevenue.toString().padStart(7)} | ${
    ...
    console.log('\n\n' + '💰'.repeat(40));
    console.log(
      `\n✅ Revenue hunt complete! You have ${report.summary.totalOpportunities} ways to make money.`
    );
