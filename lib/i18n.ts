...
export interface AgentData {
  en: {
    ...
    subApps?: Record<string, { title: string; description: string }>;
  };
  ar: {
    name: string;
    description: string;
...
export const translations: {
  ...
  global: {
    en: {
      ...
      mainAIPlaceholder:
        "Ask Gemini Pro to perform a complex task (e.g., 'Plan a 7-day trip to Egypt')",
  ...
  agents: {
    ...
    travel: {
      en: {
        ...
        placeholders: {
          itineraryPrompt:
            "Describe your trip (e.g., 'a 5-day cultural trip to Rome for a family of 4')",
          flightOrigin: 'Origin',
    ...
    research: {
      ...
      ar: {
        ...
        mockResults: {
          webSearch:
            "تم العثور على 10 نتائج لـ 'أفضل تطبيقات السفر'. النتيجة الأولى: 'تطبيق Wanderlust'.",
    ...
    coding: {
      ...
      en: {
        name: 'Coding Agent',
        description:
          'Generates code with specialized sub-agents for UI, API, DevOps, QA, Documentation, and Code Review.',
        tasks: {
        ...
        placeholders: {
          projectDescription:
            "Describe the project or feature (e.g., 'A login form with email and password')",
          ...
          codeDescription:
            "Code description or function signature (e.g., 'User registration function')",
        ...
        mockResults: {
          // These are now illustrative, real data comes from Gemini
          generatedUI:
            'Generated React component for a login form:\n```jsx\n// React Login Form Code\n```',
          ...
          reviewedCode:
            'Code review: Overall good quality, but consider adding input validation. Rating: 7/10',
        },
      },
      ar: {
        name: 'عميل البرمجة',
        description:
          'ينشئ الكود مع عملاء فرعيين متخصصين لواجهة المستخدم، الـ API، DevOps، ضمان الجودة، التوثيق، ومراجعة الكود.',
        tasks: {
        ...
        placeholders: {
          projectDescription:
            "صف المشروع أو الميزة (مثال: 'نموذج تسجيل دخول بالبريد الإلكتروني وكلمة المرور')",
          ...
          featureToTest:
            "الميزة المراد اختبارها (مثال: 'تسجيل المستخدم'، 'استجابة نقطة نهاية الـ API')",
        ...
        mockResults: {
          // These are now illustrative, real data comes from Gemini
          generatedUI:
            'تم إنشاء مكون React لنموذج تسجيل الدخول:\n```jsx\n// كود نموذج تسجيل الدخول React\n```',
          ...
          reviewedCode:
            'مراجعة الكود: جودة جيدة بشكل عام، ولكن فكر في إضافة التحقق من المدخلات. التقييم: 7/10',
        },
      },
    },
    marketing: {
      ...
      en: {
        ...
        description:
          'Develops strategies, creates content, and analyzes campaigns with specialized sub-agents.',
        tasks: {
        ...
        mockResults: {
          // Updated mockResults to reflect potential grounding chunks
          marketResearch: {
            text: 'Market research complete: Identified key demographics and competitive landscape.',
            groundingChunks: [
              { web: { uri: 'https://example.com/market-trends', title: 'Market Trends 2024' } },
            ],
          },
          seoSpecialist: {
            ...
            groundingChunks: [
              {
                web: {
                  uri: 'https://developers.google.com/search/docs/fundamentals/seo-starter-guide',
          ...
          contentStrategist: {
            ...
            groundingChunks: [
              {
                web: {
                  uri: 'https://blog.hubspot.com/marketing/content-strategy',
          ...
          socialMediaManager: {
            ...
            groundingChunks: [
              { web: { uri: 'https://business.instagram.com/', title: 'Instagram for Business' } },
            ],
          },
          campaignManager: {
      ...
      ar: {
        ...
        placeholders: {
          ...
          keywords:
            "الكلمات المفتاحية (مثال: 'مساعد الذكاء الاصطناعي', 'تطبيق إنتاجي', 'مساعدة ذكية')",
          ...
          dataToAnalyze:
            "البيانات المراد تحليلها (مثال: 'حركة مرور الموقع للربع الثالث، معدلات التحويل')",
          metrics:
            "المقاييس الرئيسية (مثال: 'نسبة النقر إلى الظهور', 'العائد على الاستثمار', 'التفاعل')",
        ...
        mockResults: {
          ...
          marketResearch: {
            ...
            groundingChunks: [
              { web: { uri: 'https://example.com/market-trends', title: 'اتجاهات السوق 2024' } },
            ],
          },
          seoSpecialist: {
            ...
            groundingChunks: [
              {
                web: {
                  uri: 'https://developers.google.com/search/docs/fundamentals/seo-starter-guide',
                  title: 'دليل جوجل لتحسين محركات البحث',
                },
              },
            ],
          },
            ...
            groundingChunks: [
              {
                web: {
                  uri: 'https://blog.hubspot.com/marketing/content-strategy',
                  title: 'استراتيجية المحتوى من HubSpot',
                },
              },
            ],
          },
          socialMediaManager: {
            ...
            groundingChunks: [
              { web: { uri: 'https://business.instagram.com/', title: 'إنستغرام للأعمال' } },
            ],
          },
          campaignManager: {
          ...
          analyticsExpert: {
            ...
            groundingChunks: [
              {
                web: { uri: 'https://analytics.google.com/analytics/web/', title: 'تحليلات جوجل' },
              },
            ],
          },
        },
