...
export const translations: {
  ...
  agents: {
    ...
    marge: {
      en: {
        name: "Marge",
        description: "Central intelligence hub that launches specialized mini-apps for content, code, and communication.",
        tasks: {
        ...
        subApps: {
          contentCreator: {
            ...
            description: "Generate marketing copy, social posts, and long-form assets with grounded sources.",
          },
          codeAssistant: {
          ...
          emailHelper: {
            title: "Email Helper",
            description: "Draft professional emails, summarize long threads, and keep communication on track.",
          },
        },
      },
      ar: {
        name: "مارج",
        description: "المركز الذكي لإطلاق التطبيقات المصغّرة المتخصصة في المحتوى والبرمجة والتواصل.",
        tasks: {
        ...
        subApps: {
          contentCreator: {
            title: "صانع المحتوى",
            description: "أنشئ نسخاً تسويقية ومنشورات اجتماعية ومقالات طويلة بالاعتماد على المصادر.",
          },
          codeAssistant: {
            title: "مساعد البرمجة",
