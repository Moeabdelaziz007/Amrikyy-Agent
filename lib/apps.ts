...
export const allApps: AppDefinition[] = [
  // Agents
  {
    ...
    description: {
      en: translations.agents.nexus.en.description,
      ar: translations.agents.nexus.ar.description,
    },
    icon: UsersIcon,
    color: 'pink',
    component: NexusApp,
  },
  {
    ...
    description: {
      en: translations.agents.chatbot.en.description,
      ar: translations.agents.chatbot.ar.description,
    },
  ...
  {
    id: 'marge',
    name: { en: translations.agents.marge.en.name, ar: translations.agents.marge.ar.name },
    description: {
      en: translations.agents.marge.en.description,
      ar: translations.agents.marge.ar.description,
    },
    icon: UsersIcon,
    color: 'purple',
    component: MiniAgentsHub,
  },
  {
    id: 'contentCreator',
    name: {
      en: translations.agents.contentCreator.en.name,
      ar: translations.agents.contentCreator.ar.name,
    },
    description: {
      en: translations.agents.contentCreator.en.description,
      ar: translations.agents.contentCreator.ar.description,
    },
    icon: ScrollTextIcon,
    color: 'orange',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.travel.en.description,
      ar: translations.agents.travel.ar.description,
    },
  ...
  },
  {
    ...
    description: {
      en: translations.agents.vision.en.description,
      ar: translations.agents.vision.ar.description,
    },
    icon: EyeIcon,
    color: 'purple',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.research.en.description,
      ar: translations.agents.research.ar.description,
    },
    icon: SearchIcon,
    color: 'green',
  ...
  },
  {
    id: 'translator',
    name: {
      en: translations.agents.translator.en.name,
      ar: translations.agents.translator.ar.name,
    },
    description: {
      en: translations.agents.translator.en.description,
      ar: translations.agents.translator.ar.description,
    },
    icon: LanguagesIcon,
    color: 'cyan',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.scheduler.en.description,
      ar: translations.agents.scheduler.ar.description,
    },
    icon: CalendarIcon,
    color: 'orange',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.storage.en.description,
      ar: translations.agents.storage.ar.description,
    },
    icon: HardDriveIcon,
    color: 'indigo',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.media.en.description,
      ar: translations.agents.media.ar.description,
    },
    icon: VideoIcon,
    color: 'red',
  ...
  },
  {
    id: 'communicator',
    name: {
      en: translations.agents.communicator.en.name,
      ar: translations.agents.communicator.ar.name,
    },
    description: {
      en: translations.agents.communicator.en.description,
      ar: translations.agents.communicator.ar.description,
    },
    icon: MailIcon,
    color: 'pink',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.coding.en.description,
      ar: translations.agents.coding.ar.description,
    },
    icon: CodeIcon,
    color: 'emerald',
  ...
  },
  {
    ...
    description: {
      en: translations.agents.marketing.en.description,
      ar: translations.agents.marketing.ar.description,
    },
    icon: MegaphoneIcon,
    color: 'purple',
  ...
  // System Apps
  {
    ...
    description: {
      en: translations.global.en.taskHistoryDescription,
      ar: translations.global.ar.taskHistoryDescription,
    },
    icon: HistoryIcon,
    color: 'blue',
    isSystemApp: true,
